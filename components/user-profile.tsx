  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center space-x-1 rounded-xl border-2 border-black shadow-[0_4px_0_rgba(0,0,0,1)] bg-gray-100 px-3 py-1 text-sm font-medium hover:bg-gray-200"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-48 rounded-xl border-2 border-black bg-white py-1 shadow-[0_4px_0_rgba(0,0,0,1)] ">
